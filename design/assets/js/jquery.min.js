        ...
        Y=/HTML$/i,Q=/^(?:input|select|textarea|button)$/i,J=/^h\d$/i,K=/^[^ {
                    ...
                    if(!r&&(T(e),e=e||C,E)) {
                        ...
                        if(d.qsa&&!N[t+" "]&&(!y||!y.test(t))&&(1!==p||"object"!==e.nodeName.toLowerCase())) {
                            if(c=t,f=e,1===p&&(U.test(t)||z.test(t))) {
                                ...
                                while(o--)<div style="display: inline-block;
                                "> [o]=(s?"#"+s:":scope")+" "+xe(l[o]);
                                c=l.join(",")
                            }
                            try {
            ...
            S.event= {
                ...
                add:function(t,e,n,r,i) {
                    ...
                    if(V(t)) {
                        ...
                        while(l--)d=g=(s=be.exec(e[l])||[])[1],h=(s[2]||"").split(".").sort(),d&&(f=S.event.special[d]|| {
                        },
            ...
            function He(n,r,i,o) {
                ...
                if(f&&(t=(e=xe(r,n[0].ownerDocument,!1,n,o)).firstChild,1===e.childNodes.length&&(e=t),t||o)) {
                    for(s=(a=S.map(ye(e,"script"),De)).length;
                    c<f;
                    c++)u=e,c!==p&&(u=S.clone(u,!0,!0),s&&S.merge(a,ye(u,"script"))),i.call(n[c],u,c);
                    if(s)for(l=a[a.length-1].ownerDocument,S.map(a,qe),c=0;
                    c<s;
            ...
            function Oe(e,t,n) {
                ...
                null!=(r=i[o]);
                o++)n||1!==r.nodeType||S.cleanData(ye(r)),r.parentNode&&(n&&ie(r)&&ve(ye(r,"script")),r.parentNode.removeChild(r));
                return e
            }
            S.extend( {
                ...
                clone:function(e,t,n) {
                    ...
                    if(!(v.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||S.isXMLDoc(e)))for(a=ye(c),r=0,i=(o=ye(e)).length;
                    r<i;
                    ...
                    if(t)if(n)for(o=o||ye(e),a=a||ye(c),r=0,i=o.length;
                    r<i;
                    r++)Le(o[r],a[r]);
                    else Le(e,c);
            ...
            S.fn.extend( {
                ...
                empty:function() {
                    for(var e,t=0;
                    null!=(e=this[t]);
                    t++)1===e.nodeType&&(S.cleanData(ye(e,!1)),e.textContent="");
                    return this
                },
                clone:function(e,t) {
            ...
            !function() {
                ...
                l.style&&(l.style.backgroundClip="content-box",l.cloneNode(!0).style.backgroundClip="",v.clearCloneStyle="content-box"===l.style.backgroundClip,S.extend(v, {
                    ...
                    reliableTrDimensions:function() {
                        ...
                        left:-11111px;
                        border-collapse:separate",t.style.cssText="border:1px solid",t.style.height="1px",n.style.height="9px",n.style.display="block",re.appendChild(e).appendChild(t).appendChild(n),r=C.getComputedStyle(t),a=parseInt(r.height,10)+parseInt(r.borderTopWidth,10)+parseInt(r.borderBottomWidth,10)===t.offsetHeight,re.removeChild(e)),a
                    }
                }))
            }
            ();
            ...
            S.Animation=S.extend(ft, {
                ...
                prefilters:[function(e,t,n) {
                    ...
                    h=e.style,g=e.nodeType&&ae(e),y=Y.get(e,"fxshow");
            ...
            S.fn.extend( {
                ...
                toggleClass:function(t,n) {
                    ...
                    :"boolean"==typeof n&&s?n?this.addClass(t):this.removeClass(t):(e=mt(t),this.each(function() {
                        if(s)for(o=S(this),i=0;
                        i<e.length;
                        i++)r=e[i],o.hasClass(r)?o.removeClass(r):o.addClass(r);
            ...
            Wt.href=Tt.href,S.extend( {
                ...
                ajaxPrefilter:Ft(Rt),ajaxTransport:Ft(Mt),ajax:function(e,t) {
                    ...
                    q=0.01":""):y.accepts["*"]),y.headers)T.setRequestHeader(i,y.headers[i]);
